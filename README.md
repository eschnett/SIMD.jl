...
`abs cbrt ceil copysign cos div exp exp10 exp2 floor fma ifelse inv isfinite isinf isnan issubnormal log log10 log2 muladd rem round sign signbit sin sqrt trunc`

(Currently missing: `copysign(Int) count_ones count_zeros expm1 flipsign ldexp leading_ones leading_zeros log1p significand trailing_ones trailing_zeros`)
